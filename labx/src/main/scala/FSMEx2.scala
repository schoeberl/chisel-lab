...
class UpDownFSM2() extends Module {
...
object FSMTop2Driver extends App {
    chisel3.Driver.execute(Array("--target-dir", "generated", "-tn", "fsm_top"), () => new FSMTop2())
}